...
var file_protos_greetings_service_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc5, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x65,
	...
	0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x12, 0x40,
...
var file_protos_greetings_service_proto_depIdxs = []int32{
	...
	0, // 4: protos.GreetService.GreetEveryone:input_type -> protos.GreetRequest
	1, // 5: protos.GreetService.Greet:output_type -> protos.GreetResponse
	1, // 6: protos.GreetService.GreetWithDeadline:output_type -> protos.GreetResponse
	1, // 7: protos.GreetService.GreetManyTimes:output_type -> protos.GreetResponse
	1, // 8: protos.GreetService.LongGreet:output_type -> protos.GreetResponse
	1, // 9: protos.GreetService.GreetEveryone:output_type -> protos.GreetResponse
